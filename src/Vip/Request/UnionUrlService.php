...
interface UnionUrlServiceIf{
	...
	public function vipLinkCheck(\LeagueAndShop\EasyTBK\Vip\Request\VipLinkCheckReq $vipLinkCheckReq);

	public function vipLinkCheckWithOuth(\LeagueAndShop\EasyTBK\Vip\Request\VipLinkCheckReq $vipLinkCheckReq);

}

class _UnionUrlServiceClient extends \LeagueAndShop\EasyTBK\Vip\Osp\Base\OspStub implements \LeagueAndShop\EasyTBK\Vip\Request\UnionUrlServiceIf{
	...
	public function send_genByGoodsId( $goodsIdList, $chanTag, $requestId){
		...
		$args = new \LeagueAndShop\EasyTBK\Vip\Request\UnionUrlService_genByGoodsId_args();
	...
	public function recv_genByGoodsId(){
		...
		$result = new \LeagueAndShop\EasyTBK\Vip\Request\UnionUrlService_genByGoodsId_result();
	...
	public function send_genByGoodsIdWithOauth( $goodsIdList, $chanTag, $requestId, $statParam){
		...
		$args = new \LeagueAndShop\EasyTBK\Vip\Request\UnionUrlService_genByGoodsIdWithOauth_args();
	...
	public function recv_genByGoodsIdWithOauth(){
		...
		$result = new \LeagueAndShop\EasyTBK\Vip\Request\UnionUrlService_genByGoodsIdWithOauth_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_genByVIPUrl( $urlList, $chanTag, $requestId){
		...
		$args = new \LeagueAndShop\EasyTBK\Vip\Request\UnionUrlService_genByVIPUrl_args();
	...
	public function recv_genByVIPUrl(){
		...
		$result = new \LeagueAndShop\EasyTBK\Vip\Request\UnionUrlService_genByVIPUrl_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_genByVIPUrlWithOauth( $urlList, $chanTag, $requestId){
		...
		$args = new \LeagueAndShop\EasyTBK\Vip\Request\UnionUrlService_genByVIPUrlWithOauth_args();
	...
	public function recv_genByVIPUrlWithOauth(){
		...
		$result = new \LeagueAndShop\EasyTBK\Vip\Request\UnionUrlService_genByVIPUrlWithOauth_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_healthCheck(){
		...
		$args = new \LeagueAndShop\EasyTBK\Vip\Request\UnionUrlService_healthCheck_args();
	...
	public function recv_healthCheck(){
		...
		$result = new \LeagueAndShop\EasyTBK\Vip\Request\UnionUrlService_healthCheck_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_vipLinkCheck(\LeagueAndShop\EasyTBK\Vip\Request\VipLinkCheckReq $vipLinkCheckReq){

		$this->initInvocation("vipLinkCheck");
		$args = new \LeagueAndShop\EasyTBK\Vip\Request\UnionUrlService_vipLinkCheck_args();
	...
	public function recv_vipLinkCheck(){
		...
		$result = new \LeagueAndShop\EasyTBK\Vip\Request\UnionUrlService_vipLinkCheck_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_vipLinkCheckWithOuth(\LeagueAndShop\EasyTBK\Vip\Request\VipLinkCheckReq $vipLinkCheckReq){

		$this->initInvocation("vipLinkCheckWithOuth");
		$args = new \LeagueAndShop\EasyTBK\Vip\Request\UnionUrlService_vipLinkCheckWithOuth_args();
	...
	public function recv_vipLinkCheckWithOuth(){
		...
		$result = new \LeagueAndShop\EasyTBK\Vip\Request\UnionUrlService_vipLinkCheckWithOuth_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class UnionUrlService_vipLinkCheck_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->vipLinkCheckReq = new \LeagueAndShop\EasyTBK\Vip\Request\VipLinkCheckReq();
...
class UnionUrlService_genByGoodsId_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \LeagueAndShop\EasyTBK\Vip\Request\UrlGenResponse();
...
class UnionUrlService_vipLinkCheck_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \LeagueAndShop\EasyTBK\Vip\Request\VipLinkCheckResp();
			$this->success->read($input);
