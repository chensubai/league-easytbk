	...
	public function read($input){
		...
		while(true){
			...
			if ("storeInfo" == $schemeField){
				...
				$this->storeInfo = new \LeagueAndShop\EasyTBK\Vip\Request\StoreInfo();
			...
			if ("commentsInfo" == $schemeField){
				...
				$this->commentsInfo = new \LeagueAndShop\EasyTBK\Vip\Request\GoodsCommentsInfo();
			...
			if ("storeServiceCapability" == $schemeField){
				...
				$this->storeServiceCapability = new \LeagueAndShop\EasyTBK\Vip\Request\StoreServiceCapability();
