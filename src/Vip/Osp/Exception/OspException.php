...
namespace LeagueAndShop\EasyTBK\Vip\Osp\Exception;
...
// 	}
	...
	public function __construct($returnMessage, $returnCode=\LeagueAndShop\EasyTBK\Vip\Osp\Exception\OspException::CALLEE_UNKNOWN_EXCEPTION) {
		$this->returnCode = $returnCode;
		$this->returnMessage = $returnMessage;
	}
